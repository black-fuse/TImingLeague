...
public class QualifyHeat {
    ...
    public static boolean passQualyLap(Driver driver, org.bukkit.Location from, org.bukkit.Location to, me.makkuusen.timing.system.track.regions.TrackRegion region) {
