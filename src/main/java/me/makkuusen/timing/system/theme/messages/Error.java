...
public enum Error implements Message {
    ...
    NO_HEX_COLOR_IN_TS_COLOR,
    CUSTOM_BOATUTILS_MODE_NOT_FOUND,
    CUSTOM_BOATUTILS_MODE_EXISTS,
    CUSTOM_BOATUTILS_MODE_INVALID_NAME,
    NO_CUSTOM_BOATUTILS_MODE_SELECTED,
    FAILED_TO_SAVE_CUSTOM_BOATUTILS_MODE,
    FAILED_TO_DELETE_CUSTOM_BOATUTILS_MODE,
    WRONG_OR_MISSING_BOATUTILS,
    TEAM_NAME_TAKEN,
    TEAM_NOT_FOUND,
    ...
    PLAYER_NOT_IN_TEAM,
    DRIVER_SWAP_BOAT_SWITCHING_DISABLED,
    DRIVER_SWAP_NOT_SAME_TEAM,
    DRIVER_SWAP_NOT_IN_ACTIVE_HEAT,
    DRIVER_SWAP_HEAT_FINISHED,
    DRIVER_SWAP_NOT_IN_PIT,
    DRIVER_SWAP_ALREADY_IN_HEAT,
    DRIVER_SWAP_DRIVER_ONLINE,
    DRIVER_SWAP_NO_ONLINE_MEMBERS,
    DRIVER_EXIT_BOAT_IN_HEAT,
    DRIVER_EXIT_BOAT_IN_HEAT_P2
    ;
